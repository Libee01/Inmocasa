...
<body>
    ...
    <div id="menu1">
        <ul>
                    <li class="lista1"><a href="../../invitado/inicio_invitado.html">Iniciar Sesión</a></li>
                    <li class="lista1"><a href="../../invitado/registro_invitado.html">Registrarse</a></li>
        </ul>
	</div>
    <div id='tabla'>
        <?php
        ...
        {
            echo "<table border='1'>";
            echo "<tr><th>Calle</th><th>Imagen</th></tr>";
