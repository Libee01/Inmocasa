...
<body>
    ...
    session_start();
        ...
        $query="update pisos set calle='$calle',numero='$numero',piso='$piso',puerta='$puerta',
        cp='$codigop',metros='$metros',zona='$zona',precio='$precio',imagen='$nombreFichero' where Codigo_piso='$cod'";
        //echo "$query.<br>";

        if(mysqli_query($conexion,$query))
        {
            echo "<div class='borrado'>Piso Actualizado</div>";
